...
class RosNodeControlImpl : public RosNodeControlInterface {
    public:
        ...
        void setSlamCloudBodyRect(int front_mm, int back_mm, int left_mm, int right_mm) override {
            body_front_mm_ = front_mm;
            body_back_mm_ = back_mm;
            body_left_mm_ = left_mm;
            body_right_mm_ = right_mm;
        }
        int slamCloudBodyFront() const override { return body_front_mm_; }
        int slamCloudBodyBack() const override { return body_back_mm_; }
        int slamCloudBodyLeft() const override { return body_left_mm_; }
        int slamCloudBodyRight() const override { return body_right_mm_; }
        bool slamCloudBodyFilterEnabled() const override {
            return body_front_mm_ > 0 || body_back_mm_ > 0 || body_left_mm_ > 0 || body_right_mm_ > 0;
        }
    private:
        ...
        int body_front_mm_ = 0;
        int body_back_mm_ = 0;
        int body_left_mm_ = 0;
        int body_right_mm_ = 0;
    };
...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        g_rosNodeControlImpl.setSlamCloudBodyRect(
            get_key_value("slam_cloud_body_front_mm", 0),
            get_key_value("slam_cloud_body_back_mm", 0),
            get_key_value("slam_cloud_body_left_mm", 0),
            get_key_value("slam_cloud_body_right_mm", 0));
