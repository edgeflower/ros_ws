#ifndef RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_OK_HPP_
...
* 如果状态不正常（血量低于阈值或热量高于阈值），返回失败；否则返回成功。
* @param[in] message 机器人状态话题 id
* @param[in] hp_threshold 最低血量阈值（哨兵最大血量 600）
...
#endif // RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_STATUS_OK_HPP_