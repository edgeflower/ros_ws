#ifndef RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_FRIEND_OK_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_FRIEND_OK_HPP_
...
/**
* @brief condition 节点，用于判断队友的平均血量是否高于敌方的平均血量
* @param[in] message 我方全体机器人血量话题 id
...
public: 
    ...
    static BT::PortsList providedPorts()
    {
        return {
            ...
            BT::OutputPort<std::string>("friend_color")
        };
    }
};
}   //namespace rm_behavior_tree

#endif // RM_BEHAVIOR_TREE__PLUGINS__CONDITION__IS_FRIEND_OK_HPP_