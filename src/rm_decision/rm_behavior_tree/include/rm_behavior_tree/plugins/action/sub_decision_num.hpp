#ifndef RM_BEHAVIOR_TREE__PLUGINS__ACTION_SUB_DECISION_NUM_HPP_
#define RM_BEHAVIOR_TREE__PLUGINS__ACTION_SUB_DECISION_NUM_HPP_
...
class SubDecisionNumAction : public BT::RosTopicSubNode<rm_decision_interfaces::msg::DecisionNum>{
    public:
    SubDecisionNumAction (const std::string & name,const BT::NodeConfig & conf , const BT::RosNodeParams & params);
