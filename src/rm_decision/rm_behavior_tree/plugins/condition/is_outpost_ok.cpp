...
: BT::SimpleConditionNode(name ,std::bind(&IsOutPostOKCondition::checkRobotStatus, this), config)
{

}

BT::NodeStatus IsOutPostOKCondition::checkRobotStatus()
{
    int hp_threshold = 0 , outpost_hp = 0;
