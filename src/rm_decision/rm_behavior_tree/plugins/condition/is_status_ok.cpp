...
{
    int hp_threshold, heat_threshold, shot_threshold;
    ...
    getInput("shot_threshold",shot_threshold);
    ...
    int current_shot = msg->shot_allowance;

    RCLCPP_DEBUG(rclcpp::get_logger("IsStatusOK"),
    ...
    RCLCPP_DEBUG(rclcpp::get_logger("IsStatusOK"), "✅ 状态正常");
