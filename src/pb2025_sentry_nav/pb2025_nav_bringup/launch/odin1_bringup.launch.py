...
def generate_launch_description():
    ...
    # 使用 condition 选项来决定 如果有namespace 那么加上 /namespace  若没有就不加 /
        ...
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(launch_dir, "odin1_slam.launch.py")
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(launch_dir, "odin1_location.launch.py")
                ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    os.path.join(launch_dir, "odin1_nav.launch.py")
                ),
                launch_arguments={
                    "namespace": namespace,
                    "use_sim_time": use_sim_time,
